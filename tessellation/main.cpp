...
int main()
{
    ...
    builder.EnableBase();
    builder.EnableFeatures(vk::PhysicalDeviceFeatures().setTessellationShader(vk::True).setFillModeNonSolid(vk::True));

    {
        ...
        vulkan::CompilingShadersApplicationState::AddToApplication(application, "Tessellation State");

        application.AddAndCreateState<TessellationApplicationState>("Tessellation State");
